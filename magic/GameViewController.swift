...
//  magic
//
//  Created by luozhifan on 2017/9/11.
...
//                }
    ...
    func dialogOKCancel(question: String, text: String) -> Void {
        ...
        let alert = UIAlertController(title: question, message: text, preferredStyle: UIAlertControllerStyle.alert)
        alert.addAction(UIAlertAction(title: "OK", style: UIAlertActionStyle.default, handler: { action in
            if action.style == .default {
                self.resetMagic(random: true)
            }}))
        alert.addAction(UIAlertAction(title: "Next Level", style: UIAlertActionStyle.default, handler: { action in
            if action.style == .default {
                self.level += 1
                self.resetMagic(random: true)
            }
...
//            button.bezelStyle = .texturedSquare
        ...
        click.image = UIImage(named:"box.png")
    ...
    func doRotate(_ sender: UIButton) {
